...
local _DefaultWatermark = ("Sense Client")
local _ProtectionService = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Toon-arch/SenseClient/main/modules/protection.lua"))();
